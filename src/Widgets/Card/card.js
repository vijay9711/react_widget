...
const Card = (props) => {
  ...
  return (
    <div data-aos="fade-right" data-aos-delay={getDelayDuration(props.index)}  key={props.index} onClick={(event) => selectedItem(event, props.item, props.index)} className="group bg-main text-white rounded-xl shadow:lg border-1 overflow-hidden m-5 cursor-pointer hover:shadow-mainColorShadow duration-500 z-0">
